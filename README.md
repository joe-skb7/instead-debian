...
```bash
$ wget https://downloads.sourceforge.net/project/instead/instead/3.3.2/instead_3.3.2.tar.gz -O instead_3.3.2.orig.tar.gz
$ wget https://downloads.sourceforge.net/project/instead/instead/3.3.2/instead_3.3.2.tar.gz.asc -O instead_3.3.2.orig.tar.gz.asc
```
