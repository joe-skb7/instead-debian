...
```bash
$ wget https://downloads.sourceforge.net/project/instead/instead/3.1.1/instead_3.1.1.tar.gz -O instead_3.1.1.orig.tar.gz
$ wget https://downloads.sourceforge.net/project/instead/instead/3.1.1/instead_3.1.1.tar.gz.asc -O instead_3.1.1.orig.tar.gz.asc
```
